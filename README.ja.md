...
2. ファイル名が`macos-apple-silicon-standalone.zip`で終わる最新版をダウンロードします。
...
Star、不具合報告、動作テスト、コードへの貢献を歓迎します。任意のカンパを
受け取ることも各ライセンスと両立しますが、現時点では公式の送金先を設定して
いません。送金する場合は、将来このリポジトリ内に掲載される公式リンクだけを
利用してください。
